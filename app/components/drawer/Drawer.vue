<template>
    <div>
        <TransitionRoot as="template" :show="drawer.open">
            <Dialog class="relative z-100" @close="drawer.open = false">
                                    ...
                                    <div
                                        ...
                                        <div class="px-4 sm:px-6">
                                            <div class="flex items-start justify-between">
                                                <DialogTitle class=" font-bold text-2xl text-gray-900 dark:text-white">
                                                    {{ drawer.company.name }}
                                                </DialogTitle>
                                        ...
                                        <div class="relative mt-6 flex-1 px-4 sm:px-6 mb-20">
                                            <article v-html="drawer.company.description"
                                                     class="prose text-text"></article>
                                        </div>
                                    </div>
                                </DialogPanel>
                            </TransitionChild>
