            ...
            >
                ...
                <aside class="min-w-0 self-start md:sticky md:top-16 md:col-span-4">
                    <div class="flex flex-col min-w-0 items-center md:items-start text-center md:text-left gap-y-5">
                            ...
                            <div class="w-full md:w-auto">
                                <h2 class="font-bold text-xl text-accent">
                                    <a :href="c.href" target="_blank">
                                        {{ c.name }}
                                        <ArrowTopRightOnSquareIcon class="size-4 inline"/>
                                    </a>
                                </h2>
                        ...
                        <!-- tech stack -->
                        <div v-if="c.techStacks?.length"
                             class="mt-8 md:mt-0 flex flex-wrap gap-5 justify-center md:justify-start max-w-full">
                            <image-hover
...
const projects = [
    ...
    },
    {
        ...
        description: "            <h5 class=\"font-bold text-heading\">Overview</h5>\n" +
            ...
            "              <li class='mt-5 md:mt-0'>Participated in game jam, where  I built a <a href=\"https://gamejolt.com/games/final-block-fantasy/86382\" target=\"_blank\">2D hack n slash game</a> in 48 hours with total strangers</li>\n" +
            "            </ul>\n" +
            "\n" +
